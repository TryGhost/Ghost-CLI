...
class Command {
    ...
    static configure(commandName, aliases, yargs, extensions) {
        if (!this.description) {
            throw new Error(i18n.t('command.errors.descriptionNotProvided', {name: commandName}));
        }
    ...
    static configureOptions(commandName, yargs, extensions, onlyOptions) {
        ...
        yargs.epilogue(i18n.t('epilogue'));
     ...
     */
    run() {
        throw new Error(i18n.t('command.errors.runNotImplemented'));
    }
    ...
    runCommand(CommandClass, argv) {
        if (!(CommandClass.prototype instanceof Command)) {
            return Promise.reject(new Error(i18n.t('command.errors.doesNotInherit')));
        }
