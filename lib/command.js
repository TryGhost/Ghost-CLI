...
class Command {
    ...
    static async _run(commandName, argv = {}, extensions) {
        ...
        // Preserve where relative output paths were requested before --dir or
        // installation discovery changes the process working directory.
        commandInstance.invocationCwd = invocationCwd;
