...
class ProcessManager {
    ...
    /**
     * This function determines whether or not the linux "ghost" user should be created for this
     * process manager
     *
     * @return {Boolean} whether or not the linux user is needed
     */
    createGhostUser() {
        // Whether or not this process manager will need the locked-down "ghost" user created
        return false;
    }
