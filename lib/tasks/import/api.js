...
async function downloadMembersExport(version, url, auth, outputFile, {required = false} = {}) {
    const authOpts = await getAuthOpts(version, url, auth);
    ...
    try {
        ...
        // Older exports may omit members, but migration bundles require a successful response.
