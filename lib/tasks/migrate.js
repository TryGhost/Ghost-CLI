    ...
    return knexMigratorPromise.then(() => {
        ...
        if (error.stderr && error.stderr.match(/CODE: ENOTFOUND/)) {
            ...
            error = new errors.SystemError({
                ...
                help: chalk.blue.underline('https://docs.ghost.org/v1/docs/troubleshooting#section-sqlite3-install-failure')
            });
        } else {
            ...
            error = new errors.ProcessError({
                ...
                stderr: error.stderr,
                environment: context.instance.system.environment,
                help: chalk.blue.underline('https://docs.ghost.org/v1/docs/troubleshooting#section-general-update-error'),
