...
async function nodeVersion(ctx) {
...
See ${chalk.underline.blue('https://ghost.org/faq/node-versions/')} for more information`,
            task: taskTitle
        });
    }
    ...
    await checkDirectoryAndAbove(process.argv[0], 'install node and Ghost-CLI', taskTitle);
}
