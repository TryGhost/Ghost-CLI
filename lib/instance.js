...
class Instance {
    ...
    /**
     * Node Binary path used when installing this version
     *
     * @property nodeBinary
     * @type string
     * @public
     */
    get nodeBinary() {
        return this._cliConfig.get('node-binary', process.execPath);
    }
    set nodeBinary(value) {
        this._cliConfig.set('node-binary', value).save();
    }

    /**
     * @property nodeBinaryIsKnown
     * @returns {boolean} if the node-binary property is explicitly set
     */
    nodeBinaryIsKnown() {
        const nodeBinary = this._cliConfig.get('node-binary', null);
