...
class Instance {
    ...
    get cliConfig() {
        if (!this._cliConfig) {
            this._cliConfig = new Config(path.join(this.dir, '.ghost-cli'), !this.system.commandIsGlobal);
        }
    ...
    get config() {
        ...
        if (!this._config || this._config.environment !== currentEnv) {
            this._config = new Config(
              path.join(this.dir, `config.${this.system.environment}.json`),
              !this.system.commandIsGlobal
            );
