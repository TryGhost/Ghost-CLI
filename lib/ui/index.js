...
class UI {
    ...
    constructor(options) {
        ...
        // Add spinner object
        this.spinner = ora({spinner: 'hamburger', stream: this.stdout});
    }
    ...
    run(promiseOrFunction, name, options = {}) {
        const {clear = false, quiet = false} = options;
        ...
        const {text, isSpinning} = this.spinner;
