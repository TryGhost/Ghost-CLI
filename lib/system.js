...
class System {
    ...
    get globalConfig() {
        if (!this._globalConfig) {
            ...
            this._globalConfig = new Config(
                path.join(this.constructor.globalDir, 'config'),
                !this.commandIsGlobal
            );
        }
     ...
     */
    constructor(ui, extensions, isGlobal) {
        this.ui = ui;
        this.commandIsGlobal = Boolean(isGlobal);
