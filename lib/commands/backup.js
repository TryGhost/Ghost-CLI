...
class BackupCommand extends Command {
    async run(argv) {
        ...
        // Get the latest version in our current major. If null, we're on the latest version
        const latestVersionAvailable = await resolveVersion(null, instance.version);
        if (latestVersionAvailable && !argv.force) {
