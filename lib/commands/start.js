...
class StartCommand extends Command {
    ...
    async run(argv) {
        ...
        if (this.system.environment === 'production' && url.indexOf('http://') >= 0) {
            this.ui.log('Warning: Ghost should always be configured with an HTTPS URL in production\nFor more information, see our URL configuration FAQ at https://ghost.org/@TODO', 'yellow');
        }
