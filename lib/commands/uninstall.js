...
class UninstallCommand extends Command {
    run({force}) {
        ...
        return this.ui.confirm('Are you sure you want to do this?', force).then((confirmed) => {
            if (!confirmed) {
            ...
            return this.ui.listr([{
                ...
                title: 'Removing root-owned files in install folder',
                enabled: () => this.system.platform.linux,
                task: () => this.ui.sudo('find . -user root -type f -exec rm -f {} \\;')
            }, {
