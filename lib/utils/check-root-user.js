...
Please follow the steps here: ${chalk.blue.underline('https://docs.ghost.org/docs/troubleshooting#section-fix-root-user')} to fix your setup.\n`);
...
See ${chalk.blue.underline('https://docs.ghost.org/docs/install#section-create-a-new-user')} for more information\n`);
    }
